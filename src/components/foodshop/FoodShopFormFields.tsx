...
interface FoodShopFormFieldsProps {
  formData: FoodShopFormData;
  setFormData: React.Dispatch<React.SetStateAction<FoodShopFormData>>;
}

export const FoodShopFormFields = ({ formData, setFormData }: FoodShopFormFieldsProps) => {
